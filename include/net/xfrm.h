...
struct sk_buff *validate_xmit_xfrm(struct sk_buff *skb, netdev_features_t features, int *ret);
...
static inline struct sk_buff *validate_xmit_xfrm(struct sk_buff *skb, netdev_features_t features, int *ret)
{
	return skb;
}
